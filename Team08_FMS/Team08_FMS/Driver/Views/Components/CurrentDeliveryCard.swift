        ...
        VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 20) {
                        ...
                        HStack(alignment: .top, spacing: 18) {
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                ...
                                Text(tripController.currentTrip.startingPoint)
                        ...
                        HStack(alignment: .top, spacing: 18) {
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                Text("Destination")
                                    .font(.subheadline)
                                    .foregroundColor(.gray)
                                Text(tripController.currentTrip.destination)
                                    .font(.system(size: 20, weight: .medium))
                                    .foregroundColor(.primary)
                                Text(tripController.currentTrip.address)
                                    .font(.subheadline)
                                    .foregroundColor(.gray)
                            }
                        }
            ...
            HStack {
                VStack {
                    Text("ETA")
                        .font(.caption)
                    Text(tripController.currentTrip.eta)
                        .font(.body)
                }
                .padding()
                .background(Color.blue.opacity(0.1))
                ...
                VStack {
                    Text("Distance")
                        .font(.caption)
                    Text(tripController.currentTrip.distance)
                        .font(.body)
                }
                .padding()
