...
//            let userID = signUpResponse.user.id
    ...
    func updateTrip(_ trip: Trip) async throws {
        do {
            // Create a struct for the update data that conforms to Encodable
            ...
            // Create update data using the new struct
            let updateData = TripUpdate(trip: trip)
            
            // Print update data for debugging
            print("Updating trip with data:", updateData)
